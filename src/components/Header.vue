<template>
    <header :class="{'not-top': isTop, 'nav-sildedown': navSilde}" v-show="isFront">
        ...
        <div class="container flex-box">
            ...
            <nav>
                <li @click="onLinkClick('/')" @touchend="onLinkClick('/')" class="nav-link">首页</li>
                <li @click="onLinkClick('/archive')" @touchend="onLinkClick('/archive')" class="nav-link">归档</li>
                <li @click="onLinkClick('/about')" @touchend="onLinkClick('/about')" class="nav-link">关于</li>
            </nav>
